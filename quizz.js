const questions = [
    {
        question: "What is the maximum depth of the Epipelagic Zone, where sunlight still allows photosynthesis?",
        answer:[
        ...
        {
        question: "What is the term for the biological chemical reaction that allows deep-sea creatures to produce their own light?",
        answer:[
    ...
    {
        question: "Which zone contains the 'Abyssal Plains', covering about 50% of the Earth's surface?",
        answer:[
    ...
    {
        question: "Approximately how deep is the 'Challenger Deep', the lowest point in the Mariana Trench?",
        answer:[
    ...
    {
        question: "What do scientists call the organic debris that falls from the surface to feed the deep-sea floor?",
        answer:[
    ...
    {
        question: "How do deep-sea fish survive the immense pressure of the deep ocean?",
        answer:[
    ...
    {
        question: " The Fangtooth fish (Anoplogaster cornuta) holds a record for which physical feature relative to its size?",
        answer:[
    ...
    {
        question: "What is the average temperature of the water in the Abyssopelagic zone?",
        answer:[
    ...
    {
        question: "Which real deep-sea creature likely inspired the legend of the 'Kraken'?",
        answer:[
    ...
    { 
        question: "At 10,000 meters, the pressure is about 1,000 bars. What does this feel like?",
        answer:[
...
function nextQuestion(aI) {
    ...
    if (questionIndex === questions.length - 1) {
        questionTitle.innerText = `Quiz terminé ! Votre score : ${playerScore} / ${questions.length}`;
